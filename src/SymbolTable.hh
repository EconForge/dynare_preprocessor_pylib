...
private:
  ...
  //! Stores parameters that were automatically generated by the preprocessor
  set<int> preprocessor_generated_params;
...
public:
  ...
  */
  ...
  //! Mark a parameter as having been automatically generated by the preprocessor
  void markPreprocessorGeneratedParameter(int symb_id) noexcept(false);
  ...
  //! Get list of parameters (heterogeneous and non-heterogeneous)
  [[nodiscard]] set<int> getParameters() const;
  ...
  // Returns all parameters automatically generated by the preprocessor
  [[nodiscard]] const set<int>& getPreprocessorGeneratedParameters() const;
