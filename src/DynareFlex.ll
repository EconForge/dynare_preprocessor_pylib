...
<DYNARE_STATEMENT>aim {yylval->emplace<string>(yytext); return token::AIM;}
...
<DYNARE_STATEMENT>use_univariate_smoother_if_singularity_is_detected {return token::USE_UNIVARIATE_SMOOTHER_IF_SINGULARITY_IS_DETECTED;}
...
<DYNARE_STATEMENT>block_diagonal_lu_maxlu {return token::BLOCK_DIAGONAL_LU_MAXLU;}
<DYNARE_STATEMENT>block_diagonal_lu_nperiods {return token::BLOCK_DIAGONAL_LU_NPERIODS;}
